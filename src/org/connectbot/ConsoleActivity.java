...
public class ConsoleActivity extends Activity {
	...
	private static int toggleNum = 0;
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		if (bound != null) {
			...
			mKeyboardButton
					.setVisibility(bound.hardKeyboardHidden ? View.VISIBLE
							: View.GONE);
		}
	}
	...
	public TerminalBridge getBridge(View view) {
		TerminalView terminalView = (TerminalView) findCurrentView(R.id.console_flip);
		return terminalView.bridge;
	}

	public void inject(View view) {
		getBridge(view).injectString("sage\n");
	}

	/*
	 * addAdd(); addSub(); addMul(); addDiv(); add0()-add9(); addDecimal();
	 * addAns(); delete(); clear();
	 */
	/*
	 * buttons....
	...
	public void add0(View view) {
		getBridge(view).injectString("0");
	}

	public void add1(View view) {
		getBridge(view).injectString("1");
	}

	public void add2(View view) {
		getBridge(view).injectString("2");
	}

	public void add3(View view) {
		getBridge(view).injectString("3");
	}

	public void add4(View view) {
		getBridge(view).injectString("4");
	}

	public void add5(View view) {
		getBridge(view).injectString("5");
	}

	public void add6(View view) {
		getBridge(view).injectString("6");
	}

	public void add7(View view) {
		getBridge(view).injectString("7");
	}

	public void add8(View view) {
		getBridge(view).injectString("8");
	}

	public void add9(View view) {
		getBridge(view).injectString("9");
	}
	/*
	 * addAdd(); addSub(); addMul(); addDiv(); add0()-add9(); addDecimal();
	 * addAns(); delete(); clear();
	...
	public void clear(View view) {
		getBridge(view).injectString("clear\n");
	}
	 ...
	 * Algebra
	 * */
	public void addSqrt(View view) {
		getBridge(view).injectString("sqrt(");
	}
	...
	public void addLn(View view) {
		getBridge(view).injectString("ln(");
	}
	...
	public void addLeftP(View view) {
		getBridge(view).injectString("(");
	}

	public void addRightP(View view) {
		getBridge(view).injectString(")");
	}
	...
	public void addIntegrate(View view) {
		getBridge(view).injectString("integrate(");
	}

	public void addDerive(View view) {
		getBridge(view).injectString("diff(");
	}

	public void addLim(View view) {
		getBridge(view).injectString("lim");
	}

	public void addInfinity(View view) {
		getBridge(view).injectString("infinity");
	}
	...
	public void addX(View view) {
		getBridge(view).injectString("x");
	}

	public void addY(View view) {
		getBridge(view).injectString("y");
	}

	public void addT(View view) {
		getBridge(view).injectString("t");
	}
