...
public class WizardActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.flipper.addView(inflater.inflate(R.layout.wiz_eula, this.flipper,
				false));
	...
	protected void updateButtons() {
		...
		next.setText(eula ? getString(R.string.wizard_agree)
				: getString(R.string.wizard_next));
		prev.setText(eula ? getString(R.string.delete_neg)
